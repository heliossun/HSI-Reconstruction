...
from models_attention import ADMM_net_S9, ADMM_net_S12
...
if stage_num == 9:
    network = ADMM_net_S9(n_resblocks = n_resblocks, n_feats = n_feats, L=L).cuda()
elif stage_num == 12:
    network = ADMM_net_S12(n_resblocks=n_resblocks, n_feats=n_feats, L=L).cuda()
