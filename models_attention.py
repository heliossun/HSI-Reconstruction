...
from SRN_model_attention import SRN
...
class ADMM_net_S9(nn.Module):
    ...
    def __init__(self, n_resblocks = 8, n_feats = 16, L=4):
        super(ADMM_net_S9, self).__init__()
                
        self.unet1 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet2 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet3 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet4 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet5 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet6 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet7 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet8 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
        self.unet9 = SRN(n_resblocks, n_feats, 8, 8, L) # Unet(8, 8)
...
class ADMM_net_S12(nn.Module):
    ...
    def __init__(self, n_resblocks=8, n_feats=16, L=4):
        ...
        self.unet8 = SRN(n_resblocks, n_feats, 8, 8, L)  # Unet(8, 8)
        self.unet9 = SRN(n_resblocks, n_feats, 8, 8, L)  # Unet(8, 8)
        self.unet10 = SRN(n_resblocks, n_feats, 8, 8, L)  # Unet(8, 8)
        self.unet11 = SRN(n_resblocks, n_feats, 8, 8, L)  # Unet(8, 8)
        self.unet12 = SRN(n_resblocks, n_feats, 8, 8, L)  # Unet(8, 8)
        self.gamma1 = torch.nn.Parameter(torch.Tensor([0]))
        self.gamma2 = torch.nn.Parameter(torch.Tensor([0]))
        self.gamma3 = torch.nn.Parameter(torch.Tensor([0]))
        self.gamma4 = torch.nn.Parameter(torch.Tensor([0]))
