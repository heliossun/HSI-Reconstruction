...
class ADMM_net_large(nn.Module):

    def __init__(self, n_resblocks=8, n_feats=16):
        super(ADMM_net_large, self).__init__()
        ...
        self.unet8 = Unet(8, 8)
        self.unet9 = Unet(8, 8)
        self.unet10 = Unet(8, 8)
        self.unet11 = Unet(8, 8)
        self.unet12 = Unet(8, 8)
        self.gamma1 = torch.nn.Parameter(torch.Tensor([0]))
        self.gamma2 = torch.nn.Parameter(torch.Tensor([0]))
        self.gamma3 = torch.nn.Parameter(torch.Tensor([0]))
        self.gamma4 = torch.nn.Parameter(torch.Tensor([0]))
